...
btnGrid.addEventListener("click", ()=>{
    cols.forEach((colonne)=>{
        if (colonne.classList.contains("col-12")) colonne.classList.remove("col-12"); //Si true, retire la classe col-12
...
btnList.addEventListener("click", ()=>{
    cols.forEach((colonne)=>{
        if (colonne.classList.contains("col-md-6")) colonne.classList.remove("col-md-6");
...
items.forEach((item)=>{
    ...
    item.querySelector(".btnAddToCart").addEventListener("click", ()=>{
